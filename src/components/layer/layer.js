				...
				return (
					...
					r.open(
						i.extend(
							...
							s && !o.config.skin
								? { skin: c + " layer-hui", anim: u }
								: (function () {
										return (
											(n = n || {}),
											(n.icon === -1 || (n.icon === t && !o.config.skin)) &&
												(n.skin = c + " " + (n.skin || "layer-hui")),
											n
										);
								  })()
						)
	...
	(l.anim = [
		...
		(s.pt.vessel = function (e, t) {
			...
			return (
				...
				t(
					[
						r.shade
							? '<div class="layer-shade" id="layer-shade' +
							  a +
							  '" times="' +
							  a +
							  '" style="' +
						...
						'<div class="' +
							l[0] +
							(" layer-" + o.type[r.type]) +
							((0 != r.type && 2 != r.type) || r.shade ? "" : " layer-border") +
							" " +
							(r.skin || "") +
							'" id="' +
							l[0] +
							...
							(r.id || "") +
							'" class="layer-content' +
							(0 == r.type && r.icon !== -1 ? " layer-padding" : "") +
							(3 == r.type ? " layer-loading" + r.icon : "") +
							'">' +
							(0 == r.type && r.icon !== -1
								? '<i class="layer-ico layer-ico' + r.icon + '"></i>'
								: "") +
							(1 == r.type && e ? "" : r.content || "") +
							'</div><span class="layer-setwin">' +
							(function () {
								var e = c
									? '<a class="layer-min" href="javascript:;"><cite></cite></a><a class="layer-ico layer-max" href="javascript:;"></a>'
									: "";
								return (
									r.closeBtn &&
										(e +=
							...
							(r.btn
								...
								: "") +
							(r.resize ? '<span class="layer-resize"></span>' : "") +
							"</div>",
					],
					u,
					i('<div class="layer-move"></div>')
				),
				n
			);
		}),
				...
				switch (
					...
					case 2:
						...
						t.content =
							...
							l[4] +
							a +
							'" onload="this.className=\'\';" class="layer-load" frameborder="0" src="' +
							t.content[0] +
							'"></iframe>';
						break;
					case 3:
					...
					case 4:
						f || (t.content = [t.content, "body"]),
							...
							(t.content = t.content[0] + '<i class="layer-TipsG"></i>'),
							delete t.title,
					...
					.vessel(f, function (n, r, u) {
						c.append(n[0]),
							f
								...
								: c.append(n[1]),
							i(".layer-move")[0] || c.append((o.moveElem = u)),
							(e.layero = i("#" + l[0] + a)),
							t.scrollbar ||
				...
				(s.where = [
					function () {
						s.autoLeft(),
							...
							f
								.removeClass("layer-TipsB")
								.addClass("layer-TipsT")
					...
					function () {
						(s.tipLeft = s.left + s.width + 10),
							(s.tipTop = s.top),
							f
								.removeClass("layer-TipsL")
								.addClass("layer-TipsR")
					...
					function () {
						s.autoLeft(),
							...
							f
								.removeClass("layer-TipsT")
								.addClass("layer-TipsB")
								.css("border-right-color", t.tips[1]);
					},
					function () {
						(s.tipLeft = s.left - o[0] - 10),
							(s.tipTop = s.top),
							f
								.removeClass("layer-TipsR")
								.addClass("layer-TipsL")
								.css("border-bottom-color", t.tips[1]);
					},
				]),
				s.where[c - 1](),
		...
		(s.pt.callback = function () {
			...
			t.openLayer(),
				...
				a.shadeClose &&
					i("#layer-shade" + t.index).on("click", function () {
						r.close(t.index);
					}),
				n.find(".layer-min").on("click", function () {
					var e = a.min && a.min(n);
					e === !1 || r.min(t.index, a);
				}),
				n.find(".layer-max").on("click", function () {
					i(this).hasClass("layer-maxmin")
		...
		(o.record = function (e) {
			...
			e.find(".layer-max").addClass("layer-maxmin"), e.attr({ area: t });
		}),
		...
		(r.restore = function (e) {
			...
			r.style(
				...
				t.find(".layer-max").removeClass("layer-maxmin"),
				t.find(".layer-min").show(),
		...
		(r.close = function (e) {
			...
			if (t[0]) {
				...
				t.data("isOutAnim") && t.addClass(a),
					i("#layer-moves, #layer-shade" + e).remove(),
					6 == r.ie && o.reselect(),
					o.rescollbar(e),
					t.attr("minLeft") &&
				...
				i.extend(
					{
						...
						btn: ["&#x786E;&#x5B9A;", "&#x53D6;&#x6D88;"],
						content: l,
						skin: "layer-prompt" + c("prompt"),
						maxWidth: n.width(),
						success: function (e) {
							(s = e.find(".layer-input")),
								s.focus(),
					...
					i.extend(
						{
							...
							title: (function () {
								...
								if (e > 0)
									for (
										n = '<span class="layer-tabnow">' + t[0].title + "</span>";
										i < e;
										i++
									)
							...
							content:
								...
								(function () {
									...
									if (e > 0)
										for (
											n =
												'<li class="layer-tabli xubox_tab_layer">' +
								...
								"</ul>",
							success: function (t) {
								var a = t.find(".layer-title").children(),
									o = t.find(".layer-tabmain").children();
								a.on("mousedown", function (t) {
									...
									var n = i(this),
										a = n.index();
									n
										.addClass("layer-tabnow")
										.siblings()
										.removeClass("layer-tabnow"),
				...
				(s.imgprev = function (e) {
					...
					(s.event = function () {
						s.bigimg.hover(
							...
							s.bigimg.find(".layer-imgprev").on("click", function (e) {
								e.preventDefault(), s.imgprev();
							}),
							s.bigimg.find(".layer-imgnext").on("click", function (e) {
									...
									i.extend(
										{
											...
											moveOut: !0,
											isOutAnim: !1,
											skin: "layer-photos" + c("photos"),
											content:
												'<div class="layer-phimg"><img src="' +
												u[d].src +
												'" alt="' +
												(u[d].alt || "") +
												'" layer-pid="' +
												...
												(u.length > 1
													? '<span class="layer-imguide"><a href="javascript:;" class="layer-iconext layer-imgprev"></a><a href="javascript:;" class="layer-iconext layer-imgnext"></a></span>'
													: "") +
												'<div class="layer-imgbar" style="display:' +
												(a ? "block" : "") +
												'"><span class="layer-imgtit"><a href="javascript:;">' +
												(u[d].alt || "") +
												"</a><em>" +
												s.imgIndex +
												"/" +
											...
											success: function (e, i) {
												(s.bigimg = e.find(".layer-phimg")),
													(s.imgsee = e.find(".layer-imguide,.layer-imgbar")),
													s.event(e),
													t.tab && t.tab(u[d], e),
