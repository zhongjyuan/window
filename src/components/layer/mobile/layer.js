...
!(function (e) {
	...
	(c.prototype.view = function () {
		...
		if (
			...
			2 === n.type &&
				(n.content =
					'<i></i><i class="m-layerload"></i><i></i><p>' +
					(n.content || "") +
					"</p>"),
			n.skin && (n.anim = "up"),
			...
			(s.innerHTML =
				(n.shade
					? "<div " +
					  ...
					  ' class="m-layershade"></div>'
					: "") +
				'<div class="m-layermain" ' +
				(n.fixed ? "" : 'style="position:static;"') +
				'><div class="m-layersection"><div class="m-layerchild ' +
				(n.skin ? "m-layer-" + n.skin + " " : "") +
				(n.className ? n.className : "") +
				" " +
				(n.anim ? "m-anim-" + n.anim : "") +
				'" ' +
				(n.style ? 'style="' + n.style + '"' : "") +
				">" +
				l +
				'<div class="m-layercont">' +
				n.content +
				"</div>" +
				c +
				"</div></div></div>"),
		...
		(c.prototype.action = function (e, t) {
			...
			if (e.btn)
				for (
					var s = t[i]("m-layerbtn")[0].children, r = s.length, o = 0;
					o < r;
					o++
				)
					l.touch(s[o], a);
			if (e.shade && e.shadeClose) {
				var c = t[i]("m-layershade")[0];
				l.touch(c, function () {
