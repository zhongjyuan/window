...
new Vue({
	...
	created: function () {
		var that = this;
		Helper.loadContentFromUrl("./data.json", "get", function (err, str) {
		...
		ZHONGJYUANAPP.onReady(function () {
			ZHONGJYUANAPP.eval("getAppVersion", "", function (rel) {
				console.log(rel);
			});
		});
	},
	methods: {
		appClick: function (app) {
			if (app.url) {
				ZHONGJYUANAPP.eval("open", { url: app.url, title: app.title });
			}
		},
		...
		getRandomColor: function () {
			var r = Helper.randInt(0, 200);
			var g = Helper.randInt(0, 200);
			var b = Helper.randInt(0, 200);
			return "rgb(" + r + "," + g + "," + b + ")";
		},
	},
	computed: {
